...
{
    return calib_torque_to_current(torque, g_torque_calib_table, g_torque_calib_table_len);
}

float iq_to_torque(float iq)
{
    return calib_current_to_torque(iq, g_torque_calib_table, g_torque_calib_table_len);
}

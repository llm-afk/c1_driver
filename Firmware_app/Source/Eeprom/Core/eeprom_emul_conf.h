...
#define CYCLES_NUMBER           5U                                              /*!< Number of 10Kcycles requested, minimum 1 for 10Kcycles (default), for instance 10 to reach 100Kcycles. This factor will increase pages number */
#define GUARD_PAGES_NUMBER      2U                                              /*!< Kept for the legacy configuration; physical page groups are defined explicitly in eeprom_emul.h */
